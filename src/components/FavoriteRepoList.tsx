...
type FavoriteRepoListProps = {
  repositories: Repository[];
  markRepoUnFavorite: (id: number) => void;
};

function FavoriteRepoList(props: FavoriteRepoListProps) {
  const markAsUnfavorite = (id: number) => {
    props.markRepoUnFavorite(id);
  };
